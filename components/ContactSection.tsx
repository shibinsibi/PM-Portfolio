          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="text-left depth-2">
                ...
                <div className="font-bold text-[#1A1A1A] text-base">Email Me</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left depth-2">
                ...
                <div className="font-bold text-[#1A1A1A] text-base">LinkedIn</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left depth-2">
                <div className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Code</div>
                <div className="font-bold text-[#1A1A1A] text-base">GitHub</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left depth-2">
                <div className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Call</div>
                <div className="font-bold text-[#1A1A1A] text-base">Phone</div>
              </div>
            </a>
          </div>
        </div>
